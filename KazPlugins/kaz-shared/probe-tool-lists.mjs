...
check("① KAZ_MAIN_ROLE_BODY 派生自 main 且去掉 base 首句/末句", typeof KAZ_MAIN_ROLE_BODY === "string" && KAZ_MAIN_ROLE_BODY.startsWith("Follow the ka-whale-workflow in order:") && !KAZ_MAIN_ROLE_BODY.startsWith("You are a helpful software engineer assistant.") && !KAZ_MAIN_ROLE_BODY.endsWith("The final white response should be crisp and to the point, and only appear after reasoning and working.") && KAZ_MAIN_ROLE_BODY.includes("During working, execute persona=main plan items on the main line"));
