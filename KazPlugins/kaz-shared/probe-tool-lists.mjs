...
check("① stableMainSurface = 固定集 17，无 Plan 例外参数", stableMainSurface().size === 17 && stableMainSurface().has("create_goal") && stableMainSurface().has("update_goal") && !stableMainSurface().has("exit_plan_mode"));
