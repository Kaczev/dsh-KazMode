...
check("任务完成时注入复盘指引", reviewText.includes("[ka-whale-memory Review]"));
...
check("goal 结束注入 goal 复盘", goalSteered.some((m) => messageText(m).includes("[ka-whale-memory Review]") && messageText(m).includes("The Goal has ended.")));
