// okapibm25 —— vendored Okapi BM25 implementation (offline, no npm dependency)
// ===========================================================================
// Vendored from https://github.com/FurkanToprak/OkapiBM25 (npm: okapibm25),
// version 1.4.1, MIT License, Copyright (c) 2020 Furkan Toprak.
// Compiled from BM25.ts to a self-contained ESM module — only TypeScript type
 ...
 * @param sorter A function that allows you to sort queries by a given rule. If
 *   not provided, returns results corresponding to the original order. If this
 *   option is provided, the return type will not be an array of scores but an
 *   array of documents with their scores.
 */
export default function BM25(documents, keywords, constants, sorter) {
