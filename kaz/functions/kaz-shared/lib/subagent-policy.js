// kaz-shared —— v0.9 B3 子代理双角色层（Minimal / Stable Base / toolFilter / personaRef）
// ===========================================================================
// 目标：
//   1) 本模块只产出 v0.9 固定双角色（worker / memoryMaintainer）的
//      Minimal、Stable Base、toolFilter 与 personaRef，
