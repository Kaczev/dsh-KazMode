 ...
 *  候选 3：预设化测试环境 .dsh-test → ../../profiles/web/node_modules/kaz-shared。 */
const KAZ_SHARED_CANDIDATES = [
  join(MODULE_DIR, "functions", "kaz-shared", "lib", "tool-lists.js"),
  ...
  join(MODULE_DIR, "..", "..", "profiles", "web", "node_modules", "kaz-shared", "lib", "tool-lists.js"),
];
...
const PRESET_PERSONA_TEXT = "We are the main agent of the ka-whale-workflow."
...
/** persona 段名（dsh 0.1.5 起 persona 拆为 prefix/suffix 两段；主 persona 收口在 prefix）。 */
