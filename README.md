...
#### 直接下载Tag里面的最新版本。解压之后，用dsh打开解压之后的文件夹，后复制“ds安装法的提示词.txt”中的内容给模型，让它帮你安装即可。

#### 如果你需要更新，就复制“ds更新法的提示词.txt”中的内容给模型
...
> **dsh 版本要求**：本版 Kaz 模式仅支持 dsh `0.1.1-rc.2`（安装/更新指引第 0 步会硬校验）。dsh `0.1.2-alpha` 及以上属于 API 重组版本，Kaz 尚未适配，请勿安装——强行安装会导致 dsh 启动失败。
